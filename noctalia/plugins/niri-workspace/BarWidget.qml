...
Item {
  ...
  readonly property bool hideLastWorkspace: true
  ...
  readonly property string labelMode: (widgetSettings.labelMode !== undefined) ? widgetSettings.labelMode : "name"
  ...
  readonly property int characterCount: {
    const count = (widgetSettings.characterCount !== undefined) ? widgetSettings.characterCount : 2
    return isVertical ? Math.min(count, 2) : count;
  }

  // Pill size setting (0.5-1.0 range)
  readonly property real pillSize: (widgetSettings.pillSize !== undefined) ? widgetSettings.pillSize : 1.2
  ...
  readonly property string focusedColor: (widgetSettings.focusedColor !== undefined) ? widgetSettings.focusedColor : "primary"
  ...
  property int spacingBetweenPills: 0
  ...
  function refreshWorkspaces() {
    ...
    if (root.hideLastWorkspace && targetList.length > 1) {
      targetList.pop()
    }
